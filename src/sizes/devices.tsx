...
export const DEVICES = {
  isPhoneSmall: (width: number): boolean =>
    width <= parseInt(sizes.maxPhoneSmall),
  isPhone: (width: number): boolean => width <= parseInt(sizes.maxPhone),
  isTablet: (width: number): boolean =>
    width <= parseInt(sizes.maxTablet) && width >= parseInt(sizes.minTablet),
  isLg: (width: number): boolean => width >= parseInt(sizes.minLg),
  isLessLg: (width: number): boolean => width <= parseInt(sizes.maxLg),
  isXlg: (width: number): boolean =>
    width <= parseInt(sizes.maxXlg) && width >= parseInt(sizes.minXlg),
